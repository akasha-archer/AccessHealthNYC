...
public class StdTestCenterAdapter extends RecyclerView.Adapter<HhcFacilityViewHolder> {
    @NonNull
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull HhcFacilityViewHolder holder, int position) {
